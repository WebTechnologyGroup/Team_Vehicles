            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="teampage.php" class="dropdown-toggle" data-toggle="dropdown">Team<span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="techTeam.php">Technical</a></li>
                                <li class="divider"></li>
                                <li><a href="pmTeam.php">Product Management</a></li>
                                <li class="divider"></li>
                                <li><a href="comTeam.php">Communications</a></li>
                            </ul>
                        </li>
